...
Route::post('/app/penjualan/tambah/proses', [C_Penjualan::class, 'prosesTambahPenjualan'])->name('proses.tambah.penjualan');
Route::post('/app/penjualan/data/res', [C_Produk::class, 'getDataPenjualanRes']);
